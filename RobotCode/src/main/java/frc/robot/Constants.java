...
public final class Constants {
  ...
  // TODO: Characterize the robot !
  public static final class RobotCharacterizationConstants {
    ...
    public static final double kTurnFactorMeters = kTrackWidthMeters * Math.PI / 360;
